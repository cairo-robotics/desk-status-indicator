This project is transitioning from an Arduino board to a Raspberry Pi board. This requires a different firmware setup which is documented in the root README.
